...
class _BillDetailScreenState extends State<BillDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Payment Details", style: GoogleFonts.poppins(fontWeight: FontWeight.w300, color: const Color(0xFF2D201A))),
        backgroundColor: Colors.transparent,
        elevation: 0,
        iconTheme: const IconThemeData(color: Color(0xFF4A3028)),
        actions: [
          IconButton(
            icon: const Icon(Icons.share_rounded, color: Color(0xFF5C4A40)),
      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text(bill.partyName, style: GoogleFonts.poppins(fontSize: 36, fontWeight: FontWeight.w300, color: const Color(0xFF2D201A), letterSpacing: -1.0)),
              const SizedBox(height: 8),
              Text("Bill ID: ${bill.id}", style: GoogleFonts.poppins(color: const Color(0xFF8B7468), fontSize: 14, fontWeight: FontWeight.w300)),
              ...
              ClayContainer(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(padding: const EdgeInsets.symmetric(vertical: 20.0), child: Divider(color: const Color(0xFFDDD3CE), thickness: 1)),
                    _rowItem("Discount Applied", "₹${bill.kasar}", color: const Color(0xFF5B9E7A)),
                    Padding(padding: const EdgeInsets.symmetric(vertical: 20.0), child: Divider(color: const Color(0xFFDDD3CE), thickness: 1)),
              ...
              if (bill.status == BillStatus.pending) ...[
                Text("Process Collection", style: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.w300, color: const Color(0xFF2D201A), letterSpacing: -0.5)),
                const SizedBox(height: 8),
                Text("Enter the amounts to record this payment.", style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w300, color: const Color(0xFF8B7468))),
                ...
                GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: const Color(0xFFE8734A).withOpacity(0.4),
                    ...
                    child: Text("MARK TAKEN & COLLECT", style: GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.w400, fontSize: 14, letterSpacing: 2.0)),
                  ),
                ),
                const SizedBox(height: 48),
              ],
                ...
                ClayContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Payment Collected", textAlign: TextAlign.center, style: GoogleFonts.poppins(fontWeight: FontWeight.w300, fontSize: 24, color: Colors.white)),
                      const SizedBox(height: 10),
                      Text("Total Received: ₹${bill.collectedAmount}", textAlign: TextAlign.center, style: GoogleFonts.poppins(color: Colors.white.withOpacity(0.85), fontSize: 17, fontWeight: FontWeight.w300)),
                    ],
                  ),
                ),
            ],
  ...
  Color _getStatusColor(BillStatus status) {
    switch (status) {
      case BillStatus.pending: return const Color(0xFFE89A35);
      case BillStatus.taken: return Theme.of(context).primaryColor;
      case BillStatus.accepted: return const Color(0xFF5B9E7A);
    }
  }
  ...
  Widget _buildInputRow(String label, TextEditingController controller, {bool isAccent = false}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label, style: GoogleFonts.poppins(color: isAccent ? Theme.of(context).primaryColor : const Color(0xFF8B7468), fontSize: 13, fontWeight: FontWeight.w400)),
  ...
  Widget _rowItem(String label, String value, {bool isBold = false, double size = 16, Color? color}) {
    return Row(
      ...
      children: [
        Text(label, style: GoogleFonts.poppins(color: const Color(0xFF8B7468), fontWeight: FontWeight.w300, fontSize: 14)),
        Text(value, style: GoogleFonts.poppins(fontWeight: FontWeight.w400, fontSize: size, color: color ?? const Color(0xFF2D201A))),
      ],
    );
  }
}
